...
/*Sleep transistor technology related parameters*/
#define PARM_WHAT_OPTIMIZE		1	/* 1 optimize on allowed degradation */
						/* 2 optimize on allowed wakeuptime */
						/* 3 optimize on area */
						/* 4 optimize on leakage */
													
#define PARM_DEGRADATION_ALLOWED	0.15	/* [%] */
#define PARM_WAKEUP_TIME_ALLOWED	10e-9	/* [ns] */
#define PARM_ST_WL_MAX	6 /*the maximum ratio for a single sleep transistor*/

#define PARM_WORST_TEMPERATURE	70	/* between 20 and 130 celsius degrees */
#define PARM_TEMPERATURE	70
#define PARM_MAX_WL_RATIO	10
#define PARM_MIN_WL_RATIO	1


/* If we optimize on the Ioff or on the Ion/Ioff for each component in the
 * router.
 * [1 - optimize efficiency Ion/Ioff] 
 * [2 - optimize for less leaky best Ioff] 
 * [3 - optimize for the best Ion]
 */
#define PARM_OPT		3 /*tobe removed*/

#define PARM_OPT_IN_BUF		1
#define PARM_OPT_SWITCH		1
#define PARM_OPT_VC_ALLOCATOR	1
#define PARM_OPT_SW_ALLOCATOR	1

/* If the block is on or off due to power gating for each component in the
 * router.
 * [0 - the component is OFF thus we add the ST leakage only to the power] 
 * [1 - the component is ON thus we compute power normally + ST power] 
 */
#define PARM_ON_IN_BUF		1
#define PARM_ON_SWITCH		1
#define PARM_ON_VC_ALLOCATOR	1
#define PARM_ON_SW_ALLOCATOR	1

/* This is the maximum allowed wakeup time for each component in the router */
#define PARM_WK_TIME_IN_BUF		5e-9
#define PARM_WK_TIME_SWITCH		5e-9
#define PARM_WK_TIME_VC_ALLOCATOR	5e-9
#define PARM_WK_TIME_SW_ALLOCATOR	5e-9

/* This is the maximum allowed DEGRADATION [%] when active for each component in the router */
#define PARM_DEGRADATION_IN_BUF		0.15
#define PARM_DEGRADATION_SWITCH		0.15
#define PARM_DEGRADATION_VC_ALLOCATOR	0.15
#define PARM_DEGRADATION_SW_ALLOCATOR	0.15

/*************************************************************************************/
/** 			ORIGINAL PARAMETERS FOR ORION2.0 BELOW			    **/
/*************************************************************************************/
/*Technology related parameters */
#define PARM_TECH_POINT       45
#define PARM_TECH_POINT_UM	((double)PARM_TECH_POINT/1000)
...
#define PARM_out_buffer_type   	REGISTER		/*buffer model type, SRAM or REGISTER*/
