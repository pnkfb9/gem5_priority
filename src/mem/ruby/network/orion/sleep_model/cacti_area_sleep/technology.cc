...
void init_tech_params_cacti(double technology, bool is_tag)
{
  ...
  double Rnchannelon_cacti[NUMBER_TECH_FLAVORS];
  double Rpchannelon_cacti[NUMBER_TECH_FLAVORS];
  ...
  for (iter = 0; iter <= 1; ++iter)
  {
    ...
    if (tech == 90)
    {
      ...
      Rnchannelon_cacti[0] = nmos_effective_resistance_multiplier * vdd[0] / I_on_n[0];//ohm-micron
      Rpchannelon_cacti[0] = n_to_p_eff_curr_drv_ratio[0] * Rnchannelon_cacti[0];//ohm-micron
      ...
      Rnchannelon_cacti[1] = nmos_effective_resistance_multiplier * vdd[1] / I_on_n[1];
      Rpchannelon_cacti[1] = n_to_p_eff_curr_drv_ratio[1] * Rnchannelon_cacti[1];
      ...
      Rnchannelon_cacti[2] = nmos_effective_resistance_multiplier * vdd[2] / I_on_n[2];
      Rpchannelon_cacti[2] = n_to_p_eff_curr_drv_ratio[2] * Rnchannelon_cacti[2];
      I_off_n[2][0] = 2.14e-9;
      I_off_n[2][10] = 2.9e-9;
      ...
      if (ram_cell_tech_type == lp_dram)
      {
        ...
        Rnchannelon_cacti[3] = nmos_effective_resistance_multiplier * curr_vpp / I_on_n[3];
        Rpchannelon_cacti[3] = n_to_p_eff_curr_drv_ratio[3] * Rnchannelon_cacti[3];
    ...
    { //65nm technology-node. Corresponds to year 2007 in ITRS
      ...
      Rnchannelon_cacti[0] = nmos_effective_resistance_multiplier * vdd[0] / I_on_n[0];
      Rpchannelon_cacti[0] = n_to_p_eff_curr_drv_ratio[0] * Rnchannelon_cacti[0];
      I_off_n[0][0] = 1.96e-7;
...
//      Rpchannelon_cacti[0] = n_to_p_eff_curr_drv_ratio[0] * Rnchannelon[0];//ohm-micron
...
//      Rpchannelon_cacti[1] = n_to_p_eff_curr_drv_ratio[1] * Rnchannelon[1];//ohm-micron
...
//        Rpchannelon_cacti[3] = n_to_p_eff_curr_drv_ratio[3] * Rnchannelon[3];//ohm-micron
...
//
      ...
      g_tp.peri_global.Vdd_cacti       += curr_alpha * vdd[peri_global_tech_type];
      ...
      g_tp.peri_global.R_nch_on  += curr_alpha * Rnchannelon_cacti[peri_global_tech_type];
      g_tp.peri_global.R_pch_on  += curr_alpha * Rpchannelon_cacti[peri_global_tech_type];
      ...
      g_tp.sram_cell.Vdd_cacti       += curr_alpha * vdd[ram_cell_tech_type];
      ...
      g_tp.sram_cell.R_nch_on  += curr_alpha * Rnchannelon_cacti[ram_cell_tech_type];
      g_tp.sram_cell.R_pch_on  += curr_alpha * Rpchannelon_cacti[ram_cell_tech_type];
      ...
      g_tp.dram_wl.R_nch_on   += curr_alpha * Rnchannelon_cacti[dram_cell_tech_flavor];
      g_tp.dram_wl.R_pch_on   += curr_alpha * Rpchannelon_cacti[dram_cell_tech_flavor];
...
//    g_tp.max_w_nmos_ = 100 * g_ip->F_sz_um; 
    ...
    g_tp.dram.Vbitpre_cacti = g_tp.dram_cell_Vdd; 
    g_tp.sram.Vbitpre_cacti = vdd[ram_cell_tech_type];
    ...
    for (iter=0; iter<=1; ++iter)
    {
      ...
      if (tech == 90)
      {
        ...
        alpha_scatter = 1;
        wire_r_per_micron[0][0] = wire_resistance_cacti(CU_RESISTIVITY, wire_width,
        ...
        wire_c_per_micron[0][0] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
        ...
        wire_r_per_micron[0][1] = wire_resistance_cacti(CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        wire_c_per_micron[0][1] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
            fringe_cap);
        ...
        wire_r_per_micron[0][2] = wire_resistance_cacti(CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        ild_thickness = 0.96;
        wire_c_per_micron[0][2] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
            fringe_cap);
        ...
        dishing_thickness = 0;
        alpha_scatter = 1;
        wire_r_per_micron[1][0] = wire_resistance_cacti(CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        ild_thickness = 0.48;
        miller_value = 1.5;
        ...
        wire_c_per_micron[1][0] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
            fringe_cap);
        ...
        wire_r_per_micron[1][1] = wire_resistance_cacti(CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        wire_c_per_micron[1][1] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
            fringe_cap);
        ...
        wire_r_per_micron[1][2] = wire_resistance_cacti(CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        ild_thickness = 1.1;
        wire_c_per_micron[1][2] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
            fringe_cap);
      ...
      else if (tech == 65)
      {
        ...
        dishing_thickness = 0;
        alpha_scatter = 1;
        wire_r_per_micron[0][0] = wire_resistance_cacti(BULK_CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        ild_thickness = 0.405;
        miller_value = 1.5;
        ...
        wire_thickness = aspect_ratio * wire_width;
        wire_spacing = wire_pitch[0][1] - wire_width;
        wire_r_per_micron[0][1] = wire_resistance_cacti(BULK_CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        wire_c_per_micron[0][1] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
            fringe_cap);
        ...
        wire_thickness = aspect_ratio * wire_width;
        wire_spacing = wire_pitch[0][2] - wire_width;
        wire_r_per_micron[0][2] = wire_resistance_cacti(BULK_CU_RESISTIVITY, wire_width,
            wire_thickness, barrier_thickness, dishing_thickness, alpha_scatter);
        ild_thickness = 0.81;
        wire_c_per_micron[0][2] = wire_capacitance_cacti(wire_width, wire_thickness, wire_spacing, 
            ild_thickness, miller_value, horiz_dielectric_constant, vert_dielectric_constant,
